...
st.markdown("[MIT License: Data retrieved from nfl_data_py Python package](https://github.com/Jesseknowsbest/Project_Repo/blob/main/LICENSE.txt)", unsafe_allow_html=True)
